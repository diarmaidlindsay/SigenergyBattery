package com.github.diarmaidlindsay.hermesbattery.fakes
...
class FakeSettingsStore(
    ...
    initialMonitor: MonitorConfig = MonitorConfig(5, 20.0, com.github.diarmaidlindsay.hermesbattery.domain.model.Direction.AT_OR_BELOW),
...
class HangingHermesApi : HermesApi {
    ...
    override suspend fun solarHistory(): com.github.diarmaidlindsay.hermesbattery.data.api.SolarHistoryDto =
...
class FakeHermesApi(
    ...
    private val history: com.github.diarmaidlindsay.hermesbattery.data.api.SolarHistoryDto? = null,
) : HermesApi {
    var calls = 0
    var historyCalls = 0
    ...
    override suspend fun solarHistory(): com.github.diarmaidlindsay.hermesbattery.data.api.SolarHistoryDto {
        historyCalls++
        error?.let { throw it }
        return history ?: com.github.diarmaidlindsay.hermesbattery.data.api.SolarHistoryDto()
    }
}
