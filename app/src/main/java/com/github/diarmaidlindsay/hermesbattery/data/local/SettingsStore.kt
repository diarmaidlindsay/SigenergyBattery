package com.github.diarmaidlindsay.hermesbattery.data.local
...
interface SettingsStore {
    ...
    companion object {
        ...
        val DEFAULT_API_KEY: String = com.github.diarmaidlindsay.hermesbattery.BuildConfig.HERMES_API_KEY
