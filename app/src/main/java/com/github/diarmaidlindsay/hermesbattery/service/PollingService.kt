...
import com.github.diarmaidlindsay.hermesbattery.HermesBatteryApp
import com.github.diarmaidlindsay.hermesbattery.core.notifications.NotificationHelper
import com.github.diarmaidlindsay.hermesbattery.data.api.ApiClientFactory
import com.github.diarmaidlindsay.hermesbattery.data.api.toSnapshot
import com.github.diarmaidlindsay.hermesbattery.data.local.SettingsStore
import com.github.diarmaidlindsay.hermesbattery.domain.BatteryMonitor
...
class PollingService : Service() {
    ...
    private val appContainer get() = (application as HermesBatteryApp).container
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val notification = NotificationHelper.ongoing(
            context = this,
            config = MonitorConfig(1, 0.0, com.github.diarmaidlindsay.hermesbattery.domain.model.Direction.AT_OR_ABOVE),
            lastSoc = null,
            etaLabel = null,
            transientError = null,
        )
    ...
    private fun computeEta(
        soc: Double?,
        snapshot: com.github.diarmaidlindsay.hermesbattery.domain.model.SolarSnapshot,
